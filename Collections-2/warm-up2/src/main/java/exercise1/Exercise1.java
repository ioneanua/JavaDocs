...
public class Exercise1 {
    ...
    public List<String> iteratingOverEntries(){
        ...
        for (Map.Entry<String, String> sekCountry : countries.entrySet()) {

            if(sekCountry.getKey().contains("Q") || sekCountry.getKey().contains("q")){
                seekingCountries.add( sekCountry.getKey().toLowerCase());
            }
        }
    ...
    public String iteratingOverValues(){
        ...
        for (String capital : countries.values()) {
            if (capital.length() > maxLen){
                ...
                System.out.println("The capital city with the longest name: " + seekingCapital);
            }
        }

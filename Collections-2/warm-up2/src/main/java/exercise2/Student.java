...
public class Student {
    ...
    public String toString() {
        return ("Nume: " + this.firstName + " - " + "Prenume: " + this.lastName + " - " + "ID: " + this.id + " - " + "Grade: " + this.averageGrade);
    }
    ...
    public boolean equals(Object o) {
        ...
        if(!firstName.equals(student.firstName) && !lastName.equals(student.lastName) && !averageGrade.equals(student.averageGrade) && !id.equals(student.id))
            return false;
    ...
    public int hashCode() {
        int result = id;
        result = 31 * result + lastName.hashCode() + firstName.hashCode() + id.hashCode() + averageGrade.hashCode();
